...
let areaInput = 2;
let areaInput2 = 3.14;
areaInput1 = areaInput ** 2;
outputArea = areaInput2 * areaInput1;
console.log(outputArea);

let negationInput = 11;
let negationOutput = 0;
negationOutput -= negationInput;
console.log(negationOutput);

let input1 = 70;
let input2= 1.82
input3 = input2 ** 2;
console.log( input3);
finalOutput = input1 / input3;
...
let seconds = 111;
let outputInMin = Math.floor(seconds / 60) ;
console.log(outputInMin);
let OutputInMinAndSeconds = outputInMin + "min" + seconds % 60 + "sec";
console.log(OutputInMinAndSeconds);
